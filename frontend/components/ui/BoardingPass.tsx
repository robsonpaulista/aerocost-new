      ...
      <div className="relative">
        ...
        <div className="p-4">
          ...
          <div className="flex items-center justify-between mb-3 pb-2 border-b-2 border-dashed border-gray-300">
            ...
            <div className="px-2 py-0.5 rounded-full text-xs font-semibold text-gray-700">
              {isCompleted ? (
              ...
              <div className="flex items-center justify-between flex-1">
                ...
                <div className="mx-3 flex items-center">
                  <div className="relative">
                    ...
                    <Plane className="absolute -top-2 -right-2 w-4 h-4 text-gray-400" />
                  </div>
                </div>
          ...
          <div className="flex gap-2 pt-3 border-t border-gray-200">
            {flight.flight_type === 'planned' && onMarkCompleted && (
              <button
                ...
                className="flex-1 px-3 py-1.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-xs font-medium flex items-center justify-center gap-1.5"
              >
